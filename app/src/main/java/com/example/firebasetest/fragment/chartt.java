...
public class chartt extends Fragment {
    ...
    private ThingSpeakLineChart tsChart1,tsChart2,tsChart3,tsChart4;
...
//        });
        ...
        // Create a line chart from Field1 of ThinkSpeak Channel 9
        tsChart4 = new ThingSpeakLineChart(884467, 4);
        // Get entries at maximum
        tsChart4.setNumberOfEntries(50);
        // Set value axis labels on 10-unit interval
        tsChart4.setValueAxisLabelInterval(2);
        // Set date axis labels on 5-minute interval
        tsChart4.setDateAxisLabelInterval(1);
        // Show the line as a cubic spline
        tsChart4.useSpline(true);
        // Set the line color
        tsChart4.setLineColor(Color.parseColor("#D32F2F"));
        // Set the axis color
